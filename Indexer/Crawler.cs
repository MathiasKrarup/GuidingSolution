...
namespace Indexer
{
    public class Crawler
    {
        ...
        public async Task IndexFilesIn(DirectoryInfo dir, List<string> extensions)
        {
            ...
            foreach (var file in dir.EnumerateFiles())
            {
                if (extensions.Contains(file.Extension))
                {
                    ...
                    api.SendAsync(occurrenceMessage);
